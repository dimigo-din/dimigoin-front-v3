...
const Council: React.FC = () => {
  const [councilSchedules, setCouncilSchedule] = useState<
    CouncilSchedule[] | null
  >();
  useEffect(() => {
    getCouncilSchedule()
            ...
            <Card leftBorder>
              <CardExplainContent>
                ...
                <p>
                  ...
                  성격문제, 인터넷·스마트폰과 같이 학교생활, 학업문제 전반에
                  걸친 폭넓은 고민거리를 주제로 상담사 김주은께서 진행하시는
                  상담입니다.
                </p>
                <h2>신청방법</h2>
                <p>
                  Wee 클래스 상담실(본관 2층 남쪽 복도 끝)에 직접 방문하여 상담
                  신청서를 작성한 후 상담 시간을 예약하거나, 이 페이지의
                  하단에서 받을 수 있는 상담 신청서를 작성하여 다음 이메일
                  주소로 전송한 이후 회신을 확인합니다.
                </p>
                <Outlink>hotsoul486@naver.com &gt;</Outlink>
                <h2>주의사항</h2>
                <p>
                  수업시간에 상담을 진행할 경우 보호자의 동의가 필요하며, 이에
                  필요한 보호자 동의서는 상담 신청서와 함께 이 페이지의 하단에서
                  받을 수 있습니다.
                </p>
                <DescriptionText
                  css={css`
                  ...
                  `}
                >
                  ※ 상담 신청과 상담 내용을 비롯한 상담 관련 정보는 모두 비밀
                  엄수를 보장합니다
                </DescriptionText>
              </CardExplainContent>
            </Card>
            ...
            <Card leftBorder>
              <CardExplainContent>
                ...
                <p>
                  ...
                  매주 월요일, 화요일에 상담 신청자에 한하여 신관 IT부서에서
                  진행됩니다.
                </p>
                <h2>신청방법</h2>
                <p>
                  아래의 항목에서 원하는 일시에 상담을 신청하고, 상담하고 싶은
                  주제 혹은 내용에 대해 아래 이메일 주소로 메일을 보냅니다.
                </p>
                <Outlink>soon040821@naver.com &gt;</Outlink>
              </CardExplainContent>
            </Card>
            <Table
              css={css`
              ...
              {councilSchedules?.map((councilSchedule) => {
                ...
                return (
                  <Row key={councilSchedule.detail}>
                    ...
                    <Data>
                      <label htmlFor={buttonName}>10시 0분 ~ 10시 50분</label>
                    </Data>
                    <Data>
                      <label htmlFor={buttonName}>2교시 수업시간</label>
                    </Data>
                  </Row>
                );
              })}
