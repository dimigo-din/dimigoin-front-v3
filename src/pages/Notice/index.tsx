...
const NoticeListItem: React.FC<NoticeListItemProps> = ({
  ...
  <NoticeListItemWrapper>
    ...
    {editable && (
      <>
        <EditNoticeButtonIcon
          onClick={(e) => {
            e.preventDefault();
            editAction();
          }}
        />
        <RemoveNoticeButtonIcon
          onClick={(e) => {
            e.preventDefault();
            removeAction();
          }}
...
> = ({ match, history }) => {
  ...
  const fetchNotices = useCallback(() => getAllNotices().then(setNoticesData), [
    setNoticesData,
  ]);
    ...
    <>
      <PageWrapper>
        <HeaderWrapper>
          ...
          {myData?.userType === UserType.T && (
            <MoreCompactButton onClick={newNotice}>
              <NewNoticeButtonIcon />
              글쓰기
            </MoreCompactButton>
          )}
