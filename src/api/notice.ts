...
const convertToRequestableNotice = (notice: Notice) => ({
    ...notice,
...
export const editRegisteredNotice = (id: string, data: Notice) => api<"editRegisteredNotice">("PATCH", `/notice/${id}`, convertToRequestableNotice(data))
